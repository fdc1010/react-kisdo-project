...
import ClassImg3 from '../components/img/class/class-3.jpeg';

class MathematicsClass extends Component {
    render() {
        return (
            <>
            <TopClasses/>
                            ...
                            <h2>Mathematics Classes</h2>
                                <div className="upper-box">
                                    <div className="single-item-carousel owl-carousel owl-theme">
                                        <figure className="image"><img src={ClassImg3} alt="class"/></figure>    
                                    </div>
                                </div>
