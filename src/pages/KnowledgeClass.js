...
import ClassImg5 from '../components/img/class/class-5.jpeg';

class KnowledgeClass extends Component {
    render() {
        return (
            <>
            <TopClasses/>
                ...
                <div className="container">
                    <div className="row">
                        <div className="text-column col-lg-8 col-md-8 col-sm-12">
                            <h2>Knowledge Classes</h2>
                                <div className="upper-box">
                                    <div className="single-item-carousel owl-carousel owl-theme">
                                        <figure className="image"><img src={ClassImg5} alt="class"/></figure>    
                                    </div>
                                </div>
                                    ...
                                    <div className="course-widget-price">
                                        <h2 className="widget-title">Course Features</h2>
                                            <ul>
                                                ...
                                                <li><i className="fal fa-user-graduate"></i><span>Institution</span><span clasName="time">ABC University</span></li>
