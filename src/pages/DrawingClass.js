...
import ClassImg2 from '../components/img/class/class-2.jpeg';

class DrawingClass extends Component {
    render() {
        return (
            <>   
            <TopClasses/>
                            ...
                            <h2>Drawing Classes</h2>
                                <div className="upper-box">
                                    <div className="single-item-carousel owl-carousel owl-theme">
                                        <figure className="image"><img src={ClassImg2} alt="class"/></figure>    
                                    </div>
                                </div>
